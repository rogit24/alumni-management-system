package com.alumniconnect.profileservice.util;

import com.alumniconnect.profileservice.exception.UnauthorizedException;
        ...
        if (userId == null || !StringUtils.hasText(email)) {
            ...
            if (StringUtils.hasText(authHeader) && authHeader.startsWith("Bearer ")) {
                ...
                try {
                    ...
                    System.err.println("ProfileMS JWT extraction warning: " + e.getMessage());
                }
            }
        }
